...
Public Class Biomini_Demo
    ...
    Private Sub Biomini_Demo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Biomini_Demo_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        ...
        If (ufs_res = UFS_STATUS.OK) Then
            tbxMessage.AppendText("UFScanner RemoveScannerCallback: OK" & vbNewLine)
            DrawCapturedImage(Scanner)
        Else
            UFScanner.GetErrorString(ufs_res, m_strError)
            tbxMessage.AppendText("UFScanner RemoveScannerCallback: " & m_strError & vbNewLine)
        End If
    ...
    Private Sub GetScannerTypeString(ByVal ScannerType As UFS_SCANNER_TYPE, ByRef strScannerType As String)
        ...
        ElseIf (ScannerType = UFS_SCANNER_TYPE.SFR550) Then
            strScannerType = "BioMini Plus 2"
        ElseIf (ScannerType = UFS_SCANNER_TYPE.SFR700) Then
    ...
    Private Sub btnEnroll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim udlg As Biomini_UserInfo = New Biomini_UserInfo()
        ...
        Else
            Dim dlg As Biomini_Enroll = New Biomini_Enroll()
    ...
    Private Sub cbFakeLevel_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbFakeLevel.SelectedIndexChanged
        Dim Scanner As UFScanner = Nothing
        If (GetCurrentScanner(Scanner) = False) Then
            Exit Sub
        End If
    ...
    Private Sub cbEnDetectFakeAdvanced_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbEnDetectFakeAdvanced.CheckedChanged
        Dim Scanner As UFScanner = Nothing
        Dim Ex_checked As Integer = Nothing
        If (GetCurrentScanner(Scanner) = False) Then
            Exit Sub
        End If
        If (cbEnDetectFakeAdvanced.Checked = True) Then
            Ex_checked = 1
        Else
            Ex_checked = 0
        End If
