// Biomini_EnrollDlg.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CBiomini_EnrollDlg dialog


CBiomini_EnrollDlg::CBiomini_EnrollDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CBiomini_EnrollDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CBiomini_EnrollDlg)
	m_strUserID = _T("");
	//}}AFX_DATA_INIT
}


void CBiomini_EnrollDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CBiomini_EnrollDlg)
...
BEGIN_MESSAGE_MAP(CBiomini_EnrollDlg, CDialog)
	//{{AFX_MSG_MAP(CBiomini_EnrollDlg)
	ON_WM_DESTROY()
	ON_WM_PAINT()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CBiomini_EnrollDlg message handlers

/////////////////////////////////////////////////////////////////////////////
void CBiomini_EnrollDlg::AddMessage(char* szData, ...)
{
	#define MAX_BUF 1024
...
{
	CBiomini_EnrollDlg* dlg = (CBiomini_EnrollDlg*)pParam;
...
BOOL CBiomini_EnrollDlg::OnInitDialog() 
{
...
void CBiomini_EnrollDlg::OnDestroy() 
{
	CDialog::OnDestroy();
...
void CBiomini_EnrollDlg::OnPaint() 
{
	if (IsIconic())	
	{
