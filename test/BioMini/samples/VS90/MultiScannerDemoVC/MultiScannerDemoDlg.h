// MultiScannerDemoDlg.h : header file
//

#if !defined(AFX_MULTISCANNERDEMODLG_H__548CC072_5608_4F7A_A4C4_F2AF68F425CB__INCLUDED_)
#define AFX_MULTISCANNERDEMODLG_H__548CC072_5608_4F7A_A4C4_F2AF68F425CB__INCLUDED_
...
class CMultiScannerDemoDlg : public CDialog
{
// Construction
public:
	CMultiScannerDemoDlg(CWnd* pParent = NULL);	// standard constructor
...
// Dialog Data
	//{{AFX_DATA(CMultiScannerDemoDlg)
	enum { IDD = IDD_MULTISCANNERDEMO_DIALOG };
	...
	//{{AFX_VIRTUAL(CMultiScannerDemoDlg)
	protected:
...
#endif // !defined(AFX_MULTISCANNERDEMODLG_H__548CC072_5608_4F7A_A4C4_F2AF68F425CB__INCLUDED_)
