// MultiScannerDemoDlg.cpp : implementation file
//

#include "stdafx.h"
#include "MultiScannerDemo.h"
#include "MultiScannerDemoDlg.h"
...
/////////////////////////////////////////////////////////////////////////////
// CMultiScannerDemoDlg dialog

CMultiScannerDemoDlg::CMultiScannerDemoDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMultiScannerDemoDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMultiScannerDemoDlg)
	m_strScannerID[0] = _T("");
	m_strScannerID[1] = _T("");
	m_strScannerID[2] = _T("");
	m_strScannerID[3] = _T("");
...
void CMultiScannerDemoDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMultiScannerDemoDlg)
...
BEGIN_MESSAGE_MAP(CMultiScannerDemoDlg, CDialog)
	//{{AFX_MSG_MAP(CMultiScannerDemoDlg)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CMultiScannerDemoDlg message handlers

BOOL CMultiScannerDemoDlg::OnInitDialog()
{
...
void CMultiScannerDemoDlg::OnDestroy() 
{
	CDialog::OnDestroy();
...
void CMultiScannerDemoDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CMultiScannerDemoDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

/////////////////////////////////////////////////////////////////////////////
void CMultiScannerDemoDlg::AddMessage(char* szData, ...)
{
	#define MAX_BUF 1024
...
void CMultiScannerDemoDlg::OnClearMessage() 
{
	m_message.Empty();
	m_ctlMessageEdit.SetWindowText(m_message);
}

void CMultiScannerDemoDlg::GetScannerTypeString(int nScannerType, char* strScannerType)
{
	switch (nScannerType) {
...
/////////////////////////////////////////////////////////////////////////////
void CMultiScannerDemoDlg::OnInit() 
{
	/////////////////////////////////////////////////////////////////////////////
...
void CMultiScannerDemoDlg::OnUninit() 
{
	/////////////////////////////////////////////////////////////////////////////
	// Uninit scanners
	/////////////////////////////////////////////////////////////////////////////
...
void CMultiScannerDemoDlg::StartEnrollThread(int nScannerIdx)
{
...
void CMultiScannerDemoDlg::OnEnroll1() 
{
	StartEnrollThread(0);
}

void CMultiScannerDemoDlg::OnEnroll2() 
{
	StartEnrollThread(1);
}

void CMultiScannerDemoDlg::OnEnroll3() 
{
	StartEnrollThread(2);
}

void CMultiScannerDemoDlg::OnEnroll4() 
{
	StartEnrollThread(3);
}
/////////////////////////////////////////////////////////////////////////////	
...
UINT IdentifyThread(LPVOID pParam) {
	...
	CMultiScannerDemoDlg* pDlg = pIdentifyParam->pDlg;
	UFS_STATUS ufs_res;
	UFM_STATUS ufm_res;
...
void CMultiScannerDemoDlg::StartIdentifyThread(int nScannerIdx)
{
	if (m_bIsScannerBusy[nScannerIdx]) {
		AddMessage("Scanner %d: Scanner is busy\r\n", nScannerIdx);
		return;
...
void CMultiScannerDemoDlg::OnIdentify1() 
{
	StartIdentifyThread(0);
}

void CMultiScannerDemoDlg::OnIdentify2() 
{
	StartIdentifyThread(1);
}

void CMultiScannerDemoDlg::OnIdentify3() 
{
	StartIdentifyThread(2);
}

void CMultiScannerDemoDlg::OnIdentify4() 
{
