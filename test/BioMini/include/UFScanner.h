...
#define _UFSDK_ENAPI_COMPANYID_
...
#define UFS_ERR_DEVICE_NOT_RESPOND		-10
#define UFS_ERR_CAPTURE_TIMEOUT			-11
#define UFS_ERR_USB_TIMEOUT				-12
...
#define UFS_PARAM_LFD_TYPE				313
#define UFS_PARAM_LFD_FILE				314
// Misc.
...
#define UFS_PARAM_ENCRYPTION_MODE		405
#define UFS_PARAM_NFIQ2_FILE			406
...
#define UFS_SCANNER_TYPE_SFR700			1008
...
#define UFS_MAX_IMAGE_SIDE_LENGTH 1024

#define UFS_LFD_TYPE_DEFAULT 0
#define UFS_LFD_TYPE_ADVANCED 1

#define UFS_NQS_MODE_DEFAULT			0
#define UFS_NQS_MODE_NFIQ_PERCENTILE	1
#define UFS_NQS_MODE_NFIQ				2
#define UFS_NQS_MODE_NFIQ2				3

#define UFS_ENC_MODE_DEFAULT 0
#define UFS_ENC_MODE_AES_ECB 1
#define UFS_ENC_MODE_AES_CBC 2
#define UFS_ENC_MODE_AES_PCBC 3
#define UFS_ENC_MODE_AES_CTR 4
#define UFS_ENC_MODE_AES_OFB 5
#define UFS_ENC_MODE_AES_CFB 6
...
UFS_STATUS UFS_API UFS_SetEncryptionKeyEx(HUFScanner hScanner, int nAESBlockMode, unsigned char* pKey, unsigned char* pInitialVector);
...
UFS_STATUS UFS_API UFS_CaptureSingleUIEx(HUFScanner hScanner, int nTimeout, int nOptions, BYTE* pCaptured_Buf, int* pnCaptured_Buf_Len, int *nFinger_Quality ); //Ghadir version
#endif //WIN32


#ifdef _UFSDK_ENAPI_COMPANYID_
UFS_STATUS UFS_API UFS_GetCompanyID(HUFScanner hScanner, char* szCompanyID);
# ifdef WIN32
UFS_STATUS UFS_API UFS_GetCompanyID_B(HUFScanner hScanner, BSTR* szCompanyID);
# endif
#endif //_UFSDK_ENAPI_COMPANYID_
