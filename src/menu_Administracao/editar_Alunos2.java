 ...
 * @author
 */
public class editar_Alunos2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label_EdicaoAdmin.setText("Edição de Alunos 2° ano");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editar_Alunos2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editar_Alunos2().setVisible(true);
            }
        });
    }
    ...
    private void listarAlunos(){
        try{
            ...
            ArrayList<alunosGetSet> lista = objAlunos.pesquisarAluno2();
    ...
    private void AlterarAluno(){
        ...
        if((campo_Nome.getText().isEmpty()) || (campo_Matricula.getText().isEmpty()) || (ano_inserido.getText().isEmpty())){
         ...
         objAlunosBD.alterarAluno2(objAlunos);
    ...
    private void DeletarUser(){
        ...
        alunosInsertB objAlunosBD = new alunosInsertB();
        objAlunosBD.deletarAluno2(objAlunos);
