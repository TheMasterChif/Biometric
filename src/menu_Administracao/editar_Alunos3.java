 ...
 * @author
 */
public class editar_Alunos3 extends javax.swing.JFrame {

    /**
     * Creates new form gerenciamento_Admin
     */
    public editar_Alunos3() {
        initComponents();
        listarAlunos();
    }
    ...
    private void initComponents() {
        ...
        label_EdicaoAdmin.setText("Edição de Alunos 3° ano");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editar_Alunos3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editar_Alunos3().setVisible(true);
            }
        });
    }
    ...
    private void listarAlunos(){
        try{
            ...
            ArrayList<alunosGetSet> lista = objAlunos.pesquisarAluno3();
    ...
    private void AlterarAluno(){
        ...
        if((campo_Nome.getText().isEmpty()) || (campo_Matricula.getText().isEmpty()) || (ano_inserido.getText().isEmpty())){
         ...
         objAlunosBD.alterarAluno3(objAlunos);
    ...
    private void DeletarUser(){
        ...
        alunosInsertB objAlunosBD = new alunosInsertB();
        objAlunosBD.deletarAluno3(objAlunos);
